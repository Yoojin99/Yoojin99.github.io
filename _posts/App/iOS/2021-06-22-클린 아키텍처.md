...
일반적으로 Data Repository들은 API Data service와 Persistent Data Storage 를 포함한다. Data Repository는 데이터를 리턴하기 위해 이 두 의존성을 갖는다. 룰은 처음에 
...
의존성 주입은 한 객체가 다른 객체의 의존성을 제공하는 기술이다. 앱의 DIContainer는 모든 주임을 해주는 클래스이다.
